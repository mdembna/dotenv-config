...
function getFile(customPath, defaultPath, required = false) {
...
module.exports = (settings) => {
  ...
  const envPath = getFile(settings.envPath, defaultEnvPath);
  const configPath = getFile(settings.configPath, defaultConfigPath, true);
